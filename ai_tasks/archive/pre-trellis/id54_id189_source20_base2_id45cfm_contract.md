...
- Added a non-mutating merger in commit `15548cdf`. The previous 120-rollout selector now remains the entry point, while Base seed2's existing turn cards include the CFM strip. Local derived entry: `nimloth-artifacts/id189_source20_base_common120_retry4_cfm_derived/extracted/index.html`. Its manifest explicitly records `1/120` reconstructed rollouts and preserves source manifest SHA256 `6d555cd8...de60`.
