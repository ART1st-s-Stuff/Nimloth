...
- A checksummed 314 MiB view-only archive was derived from the canonical Browser and downloaded to local `nimloth-artifacts/id189_source20_base_common120_retry4_view_only/`. It contains 121 HTML pages and 1,982 real PNGs; raw NPZ and standalone rollout JSON remain only in the canonical verified archive. Archive SHA256 is `6ce92573d6abc72be68e90397fbdda4ea19d5cb89f36a0d3be7c8648aa74d181`. See E0142.
