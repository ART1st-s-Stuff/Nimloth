...
- corrected ID178保持所有behavior/search参数，分离`--model=ID176 repair`和`--critic-checkpoint=original ID74 root`，分别固定Qwen shards/complete marker与ID74 training_state/planning sidecar SHA。尚未提交或启动。
