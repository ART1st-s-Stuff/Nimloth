...
- 人类要求继续后，preflight再次确认retry root和W&B absent、旧failure root保留、fresh runtime clean；实时normal没有两个允许节点各空4卡。Phase1 retry4 Job`520885`于18:51提交strict 2×4 H800/64CPU/256GiB/5h，现`PENDING(Priority)`且未创建retry output/W&B。phase2仍等待有效phase1 step5/validator/W&B。
