...
- 4×2 Phase1 Job`520935`始终pending、elapsed0、无节点/output/W&B；人类随后临时允许dgx-23/37，故取消。ID183专用Phase1/2和runtime gate现只排除13/32/51，parent=`f37abda7`，服务器launcher`11 passed`。fresh runtime重验retry output/W&B absent；Phase1 Job`521033`于21:51提交相同4×2/总资源/5h合同，现`PENDING(Priority)`、预计23:02，候选23/27/30/37。phase2仍等待有效phase1 step5/validator/W&B。
