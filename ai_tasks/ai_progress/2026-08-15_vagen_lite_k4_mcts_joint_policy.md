...
- 人类批准继续后新增ID177 optimizer-free校准入口，严格绑定ID176 complete marker、两个新Qwen shard SHA和所有planning sidecar SHA；仍使用24条train3×8 trajectory、每条20 turns、TP8、K4/100/c1、beta0及seed172001。入口无optimizer/checkpoint/W&B/canary，并在proposal落盘后停止等待人类批准beta。尚未启动ID177。
