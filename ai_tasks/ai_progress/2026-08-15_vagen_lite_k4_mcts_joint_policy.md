...
- retry1保留4×2并排除09/13/32/51，fresh Parent`24f52558`，新`_retry1` output和W&B `nimloth-id184-k4-continue-to20-retry1`；server launcher回归15 passed、output/W&B absent。Job`521910`于17:14提交normal exact4×2/64CPU/256GiB/5h，现`PENDING(Priority)`、elapsed0；test-only预测18:44在18/21/30/37启动。
