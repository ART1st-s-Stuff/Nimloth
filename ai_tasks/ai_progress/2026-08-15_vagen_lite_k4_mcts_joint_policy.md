...
- Job`521267`在`dgx-[18,21,27,29]`以role-aware head18完成Phase1：`COMPLETED 0:0`、elapsed`01:26:15`。step0 held-out5×8为21/40 success、reward mean0.67699995；updates1–5完成，source781/activation5，唯一checkpoint为完整`global_step_5`，snapshot=`sha256:151495...ae6`。W&B API finished且steps0..5；phase/cluster cleanup为空，四节点pre/post Ray capture齐全。step5 token-KL sum52589.48、actor grad norm46998.12虽finite且validator通过，已在README保留。Phase1不可重跑/覆盖，Phase2前置条件满足但尚未提交。
