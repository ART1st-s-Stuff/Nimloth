...
- fresh runtime确认retry1证据保留、retry2 output/W&B absent。retry2提交客户端报Slurm`Unexpected message received`，但controller实际接受Job`521163`；scontrol为normal exact4×2/64CPU/256GiB/5h、仅排除13/32/51、fresh command，现`PENDING(Priority)`、预计00:33、候选18/21/23/27。phase2仍等待有效step5/validator/W&B。
