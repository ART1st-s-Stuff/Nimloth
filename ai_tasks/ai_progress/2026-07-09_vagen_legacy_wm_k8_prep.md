...
- 同output/W&B从step44恢复，日志确认`aux_ddp_gradient_accumulation=sync_optimizer_boundary`、`aux_static_graph=false`；至少到step54 finite且无OOM/NCCL/reducer/missing-grad错误。旧45-51 step interval median27.353s；新45-54 median26.882s，仅1.8%加速，且含35.5s outlier时mean未改善。说明原aux all-reduce大多与backward重叠，主要wall瓶颈仍为Qwen current/next forward、gradient-checkpoint recompute、pair model compute和Full8192本身。当前粗估约12–12.5h/epoch、60–63h/5epochs。
