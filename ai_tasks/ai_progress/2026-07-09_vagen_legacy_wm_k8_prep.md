...
- projected-native CFM链完成：formal479794 W&B`gygcldff`,full correct.0405128/shuffled.0406263/ratio1.002801未过condition gate；eval479795 W&B`885911vb`,predicted图beige collapse。但随后确认该predicted eval无效：训练仅`predict_next_emb` T1，config history4，eval却`rollout_states` T4，positions1–3未训练，缺失history还以重复state+action0(move_forward)无mask填充。登记E0047；须重评teacher-forced T1与recursive T1，当前图不能判断learned WM质量。
