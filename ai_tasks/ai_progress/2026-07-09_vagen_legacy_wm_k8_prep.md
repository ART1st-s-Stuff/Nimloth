...
- 正式输出`.../cfm/2_cfm128_sft2e2_k8_all3217_ep10_b32_lr1e4`，计划train59,389/val6,054、10 epochs/18,560 sampled steps/b32/lr1e-4、W&B `nimloth-recon` ID2。formal job474764在训练/W&B前因逐pixel Python conversion导致preload慢而03:23主动取消；NumPy contiguous RGB等价优化`06f830a`经server5 tests通过，retry474775在normal/dgx-18运行。
