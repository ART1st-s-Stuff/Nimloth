...
- job475924 `COMPLETED00:02:14` exit0，W&B`lnzlo0ie`；12runs/60rows/action alignment全过。overall correct L1.263978 vs wrong.301747（1.143×），output diff.195369；current turn subset.256716/.298317/diff.244897。visual gate PASS/mixed fidelity：old2/3/6/7结构较好，其余partial；turn8/9跟踪brown wall/door显隐，10保持blue wall/window，11较弱。turn-left correct优于wrong；turn-right raw pixel未优但correct/wrong图差异大，uniform wall使L1失真。仅证明observed query可作coarse action-indexed trajectory reconstruction，不证明WM action dynamics/pixel fidelity。
