...
- smoke ID11：475521 plain/PEFT topology失败、475524 current512产生324而非proven81 tokens失败，均在cache/W&B前；475526修复后完成cache64/16+adapter100，W&B`b5ogtfb7`。关键positive visual gate PASS：Qwen positive恢复结构化room/door/corridor且Qwen wrong改变scene，不再mean-image；短adapter不作解释。full ID12 cache475532 normal2（strict59,389/6,054）→afterok adapter475533（10k/b128）已提交，cache pending priority、estimated start2026-07-15 15:00:59。
