...
- 64+64 smoke474752完成2 finite steps/checkpoint/sample；resume474762在训练前暴露CUDA RNG state被map到GPU的问题，记录`E0026`并由`613dcc2`修复；retry474763从step2恢复完成step3，resume通过。正式输出`.../cfm/2_cfm128_sft2e2_k8_all3217_ep10_b32_lr1e4`，job474764在normal/dgx-18运行全量preload，计划train59,389/val6,054、10 epochs/18,560 sampled steps/b32/lr1e-4，W&B `nimloth-recon` ID2。
