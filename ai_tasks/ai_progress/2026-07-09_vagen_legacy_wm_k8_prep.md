...
- 人类批准full8192/2ep：`d29df42`+`dc63c66`/server27 tests，projector16384→8192→8192、WM I/O8192、value hidden1024，checkpoint维度严格持久化，aux618.1M。smoke476051错误以max_records2复用full cache被pretrain count gate拒绝，登记E0031；CPU cache476054完成26s，retry476055同W&B`o4sugvw9`至少step16 finite、GPU约57.2GiB。正式8GPU/2ep已准备未提交，等待smoke/reload gate。
