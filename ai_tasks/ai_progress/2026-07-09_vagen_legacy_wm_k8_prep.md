...
- 人类批准full8192/2ep：`d29df42`+`dc63c66`/server27 tests，projector16384→8192→8192、WM I/O8192、value hidden1024，checkpoint维度严格持久化，aux618.1M。smoke476051错误以max_records2复用full cache被pretrain count gate拒绝，登记E0031；CPU cache476054完成26s；retry476055 `COMPLETED43:24` exit0，W&B`o4sugvw9`，32 finite steps/val WM.136024/memory57.2GiB/完整维度checkpoint；reload476156完成41s，HF+aux实际reload和[2,8192] forward finite。实测19.75s/micro×5822/ep，2ep预计65–72h on8H800（520–576 GPUh），原6–10h粗估错误。formal未提交待人类资源选择；VPN随后断开，server README最终更新未写入。
