...
- 正式续训job`477345`从完整commit`1c5db95b7ab57b92d0cef32d98758963bbfc2758`提交；当前`PENDING(Priority)`/start unknown。获得资源后自动从step1886/epoch2/micro1848恢复，复用同output、W&B`lilzcdjs`、world4/GA8和严格数据；预计clean1925+重新测四节点吞吐。
