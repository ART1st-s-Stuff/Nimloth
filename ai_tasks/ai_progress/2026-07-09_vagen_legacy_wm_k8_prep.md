...
- 新full8192 SFT2 epoch2重走recon：source明确为ID27 epoch_002 step3310（LoRA/LoRA+vision EMA），不是epoch4。`b0a386a`支持PEFT base+adapter、322 EMA shadows exact materialization、query-only跳过8192 projector/WM并fingerprint adapter/EMA；server23 tests。smoke479373完成77/12 `[8,2048]` finite，新旧cos约.39/.40。full cache479375 RUNNING dgx-54；afterok same-budget direct CFM479376和diverse40 Qwen compare479377已提交。
