...
- 同output/W&B从step44恢复，日志确认`aux_ddp_gradient_accumulation=sync_optimizer_boundary`、`aux_static_graph=false`；至少到step60 finite且无OOM/NCCL/reducer/missing-grad错误。旧45-51 step interval median27.353s；排除W&B discarded replay后的clean52-60 median26.176s，约4.5%加速；全45-60含一次35.5s outlier的median26.604s。说明原aux all-reduce大多与backward重叠，主要wall瓶颈仍为Qwen current/next forward、gradient-checkpoint recompute、pair model compute和Full8192本身。当前粗估约12h/epoch、约60h/5epochs。
