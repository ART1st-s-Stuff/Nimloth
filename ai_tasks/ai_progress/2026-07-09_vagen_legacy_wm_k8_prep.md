...
- retry job`477349`现运行于`dgx-14,dgx-26,dgx-51,dgx-54`各2GPU，dgx-27明确excluded。实际四节点smoke四rank PASS，formal default group使用IB init成功；Qwen placement一致slot0/1=81,348,096/83,148,800并启用GPU-NCCL boundary sync。latest1886/epoch2/micro1848正确加载，至少replay到1900 finite、无OOM/NCCL/non-finite；显存primary约53.5–53.6GiB、secondary约41.2GiB。clean1925+吞吐待测。
