...
- 修复commit `afe2bf92fdfc752a82d072793b3163eb66e4ff68`；相关server tests 9 passed。W&B ID2/comment=`ddpsyncfix` retry job473978已在preempt dgx-20健康越过失败点，run=`5zm5pxqx`。step1–5 total loss=`4.442450,7.054358,7.295762,2.163647,8.126086`，WM MSE=`0.276438,0.125875,0.114286,0.107240,0.106486`，均finite；8卡显存59–61GiB、采样利用率94–100%，无OOM/NaN/traceback。输出为`.../sft2/2_ddpsyncfix_k8inject_all3217_qadapter_vfull_wmtrain_ep10_b2_ga4_px100352_img12_bestwm`。
