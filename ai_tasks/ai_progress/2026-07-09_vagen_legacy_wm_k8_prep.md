...
- 新SFT2 T4-tokenized-residual实现：`1541c50`,`cbd879f` server63 tests；State8192→8×1024、T4=32tokens、masked left PAD/block-causal、zero-init residual、同record teacher-forced contexts及匹配recursive warmup；125,962,312 params。CLI/YAML/checkpoint/DDP/full-trajectory invariants严格。`5bb5a4e`新增identity-relative train/val metrics；因superpod SSH UNKNOWN65535暂未server复测/启动，昂贵实验需先确认init/resource/output/resume。
