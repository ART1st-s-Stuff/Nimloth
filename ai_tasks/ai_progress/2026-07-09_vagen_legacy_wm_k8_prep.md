...
- 同一四碎片节点launcher续训job`478282`已从exact clean commit`1fd7bc7db6590ecfeda179c5b65aa1de144d15b0`提交，仍exclude dgx-27，获得资源后先smoke再从step4799恢复并复用W&B`lilzcdjs`；初始`PENDING(Priority)`。
