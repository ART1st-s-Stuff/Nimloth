...
- projected-native CFM`fb74dec`/server10 tests：actual/predicted projected共享同CFM，五列`GT|Qwen CFM|Query CFM|Projected CFM|WM predicted CFM`并报horizon state/image drift。smoke479793 RUNNING；afterok formal479794 same30ep/55,680 recipe、eval479795。
