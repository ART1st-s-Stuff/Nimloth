...
- 人类明确要求time-limit后从checkpoint继续。commit`60c9b0b`新增直接resume 8h hetero launcher；job`477304`已提交，固定dgx-27×6+dgx-54×2，自动检测latest、复用W&B`lilzcdjs`、world4/GA8并skip epoch2前1848 micros。当前两component`PENDING(Resources)`；group1调度估计21:42，group0 start unknown。
