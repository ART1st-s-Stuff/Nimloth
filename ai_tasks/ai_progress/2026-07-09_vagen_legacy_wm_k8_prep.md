...
- direct8-query CFM实现`f76ddc6`：query manifest恢复8×2048 cross-attention、proven CFM body shape-compatible init、dropout0.15、lr3e-5→1e-5、CFG2、matched positive/query-wrong sheet；local compile/diff通过。初次连接因VPN断开按规则停止；重连后server17 tests passed。smoke475821 `COMPLETED00:00:42` exit0：64/16/10step、三个checkpoint各720 float tensors全finite、五列sheet正常，ratio1.00239仅作mechanics。formal475827已在dgx-27 RUNNING：strict59,389/6,054、55,680steps/30ep/b32、step37120降lr、每5k checkpoint可恢复、W&B ID14。
