...
- step3 deterministic scaffold residual CFM实现`e17c7c7`：6ch noisy-residual+spatial-scaffold，低t偏置`U²`，velocity MSE+0.5 image L1，server7 tests passed。tiny64 job474928已提交normal等待资源，W&B预定ID6。
