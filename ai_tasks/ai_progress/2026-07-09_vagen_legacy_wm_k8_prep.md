...
- smoke475045 `COMPLETED00:01:07`：cache77/16、alignment、paired step10/checkpoint/contact/W&B`90im9e9r`均通过；resume475048 `COMPLETED00:00:32`，cache hit、step10→12、同W&B ID。原normal8 formal475049/475050因预计2026-07-16启动而执行前取消；有效normal2 cache475052（strict59,389/6,054、expected3.75GiB、4–6h）→ afterok train475053（b16/18,560≈5ep、W&B ID10），预计cache 2026-07-15 06:07启动；已核实所有normal/preempt节点allocated/mixed，无立即可调度2GPU。formal README准备时重复E0028 unquoted-heredoc错误，仅损坏文本未影响命令，已用Python完整重写并读取核验。
