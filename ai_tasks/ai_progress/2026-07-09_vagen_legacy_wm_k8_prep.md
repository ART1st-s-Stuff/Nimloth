...
- 4GPU replacement将grad_accum从4增至8，保持4×batch2×ga8≈64的global effective batch。正式W&B project仍为`nimloth-sft2`，ID1的新run/name/output=`1_k8inject_all3217_qadapter_vfull_wmtrain_ep10_b2_ga8_ws4_px100352_img12_bestwm`。job473963固定normal dgx-14、4H800/112CPU/400G/48h提交；提交时该节点被其他作业占到仅1GPU/32CPU空闲，当前`PENDING(Priority)`，训练和W&B尚未启动。
