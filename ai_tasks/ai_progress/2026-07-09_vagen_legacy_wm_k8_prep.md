...
- 同时启动两项：`2ccf47c`/server21 tests；WM full-val teacher-forced全部8action vs identity/mean/wrong validator479922；公平Projected CFM将8192视作8×1024→8×256以匹配Query8-token interface，smoke479923→formal479924 same ID19 seed/data/body/budget→diverse40 T1 eval479925。前两项均PENDING Priority。
