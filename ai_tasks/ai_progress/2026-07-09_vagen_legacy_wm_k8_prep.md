...
- 同一四碎片节点launcher续训job`478282`从exact clean commit`1fd7bc7db6590ecfeda179c5b65aa1de144d15b0`运行于dgx-18/32/52/54各2GPU，仍无dgx-27。四rank exact-average smoke、formal IB init、Qwen placement81,348,096/83,148,800和step4799/best`.003050072753`加载全部PASS；启动5m40s时正确定性skip epoch3前11912 micros，尚未产生新optimizer step且无error。
