...
- train job473874已解除`afterok:473873`，当前normal `PENDING(Priority)`；资源查询显示没有单节点8张空闲GPU。配置为8×H800 normal/48h/requeue。正式W&B身份为project `nimloth-sft2`、run `1_k8inject_all3217_qadapter_vfull_wmtrain_ep10_b2_ga4_px100352_img12_bestwm`；训练尚未启动，因此W&B run尚未创建。
