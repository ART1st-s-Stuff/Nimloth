...
- retry2实际质量：106/960 success=11.04%；base_train56/320=17.50%，common33/320=10.31%，long17/320=5.31%。6/960 records共30/18,368 assistant turns缺action或生成unsupported `turn_down/move_down/look_left/look_right`，必须在strict conversion排除/隔离，不能生成placeholder target。其余954 records每个assistant turn恰有一个supported canonical action。由于train资产成功率远低于heldout 120-row replay71.67%，与人类“优质数据”目标存在新的不确定，续采前需确认保留all trajectories、仅success+strict-valid，或调整collection policy。
