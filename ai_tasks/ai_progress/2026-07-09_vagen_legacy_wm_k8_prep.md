...
- epoch3 global4965完成并保存`epoch_003`：val WM MSE`.003169409047`、SIGReg`.409104940`、value`.131451708`，未改善epoch2 best`.003050072753`。snapshot global6420/epoch4 step1455/1655=87.9%/total77.6%，recent median10.53s、约35min到epoch4 train end、全程纯计算剩约5.43h；latest durable6340，无error。
