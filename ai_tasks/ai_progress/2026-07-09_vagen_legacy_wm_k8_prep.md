...
- 修复commit `afe2bf92fdfc752a82d072793b3163eb66e4ff68`；相关server tests 9 passed。W&B ID2/comment=`ddpsyncfix` retry job473978在preempt dgx-20健康运行，run=`5zm5pxqx`。elapsed00:54:54时epoch1/global step896，896条train logs均finite；近期WM MSE约0.0008–0.0041，已有完整`latest/training_state.pt` periodic checkpoint可恢复。8卡显存61–64GiB、采样利用率85–100%，无OOM/NaN/traceback。输出为`.../sft2/2_ddpsyncfix_k8inject_all3217_qadapter_vfull_wmtrain_ep10_b2_ga4_px100352_img12_bestwm`。
