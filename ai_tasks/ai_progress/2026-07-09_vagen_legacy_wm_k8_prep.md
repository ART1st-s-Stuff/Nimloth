...
- job475951 `COMPLETED00:02:00` exit0，W&B`r7jitufk`。pixel L1 Qwen.275183 vs Query.277365/ratio1.00793，Query52.5% frames较低；但all-sheet human review明显Qwen语义scene fidelity/5-step stability更好（window/shower/mirror/sink/art/curtain等），Query仅coarse room/color/layout且smear/drift/warm-beige bias。L1 near tie被blur/mean color误导。结论：query有coarse视觉，Qwen ViT path细节更丰富稳定。native representation+separate CFM的practical comparison，不替代same-frozen-decoder ablation，非WM dynamics。
