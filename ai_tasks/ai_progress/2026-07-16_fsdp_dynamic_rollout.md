...
- 新增bounded create+prompt+reset+schema+close env preflight。ID17 dgx29 job478728 COMPLETED45s：create9.02s、reset0.67s、真实StoveBurner task observation和image schema通过。下一smoke指定4@dgx09+2@dgx13+2@dgx37 trainers + dedicated dgx29 env。
