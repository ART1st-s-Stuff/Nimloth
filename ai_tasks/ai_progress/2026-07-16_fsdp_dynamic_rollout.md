...
- ID12 W&B=`c8w83kd3`/output=`12_smoke_fsdpdynamic_k8full8192_sft2epoch2step3310_semantic_frag2x1_iter1_b2_visfreeze`。Prep478316 COMPLETED2:25：source adapter SHA=`d60d583...af64` exact、stable complete-Epoch2 snapshot、merge826 adapters、query IDs151665..151672、2 shards、`RL_INIT_READY`。人类要求normal碎片env后，478318双group复核PENDING/elapsed0/no allocation再取消；`be4ae85`移除dgx37 nodelist，2 trainer+1 env均为normal 1-GPU fragments，仍硬排除active SFT2 nodes18/32/52/54。replacement478337使用无artifact的同一ID12 identity/init，pending Resources；未触碰他人任务。
