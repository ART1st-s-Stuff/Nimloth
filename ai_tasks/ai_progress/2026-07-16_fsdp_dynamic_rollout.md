...
- commit d00e74f删除全部trainer nodelist和过期exclude，改为全normal节点动态4+2+1+1 fragments；server34 tests通过。ID20 active attempt3 job479019当前PENDING/Resources/elapsed0，四个trainer ReqNodeList均为空且无人工ExcNodeList；尚无trainer artifact，fixed20仍阻塞。
