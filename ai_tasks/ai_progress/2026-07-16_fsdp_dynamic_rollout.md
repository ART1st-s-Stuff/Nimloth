...
- ID12 W&B=`c8w83kd3`，最终output/run name改为`12_smoke_fsdpdynamic_k8full8192_sft2epoch2step3310_semantic_frag8x1_iter1_b2_visfreeze`。Prep478316 COMPLETED2:25：source adapter SHA=`d60d583...af64` exact、stable complete-Epoch2 snapshot、merge826 adapters、query IDs151665..151672、2 shards、`RL_INIT_READY`。固定dgx37的478318和world2碎片478337均在双group PENDING/elapsed0/no allocation复核后因人类资源修正取消，无trainer artifact。`b927727`按人类“至少8 GPU训练”改为2×4-GPU normal trainer fragments（world8）+1×1-GPU normal env，active SFT2 nodes18/32/52/54硬排除；replacement478356 pending Resources，trainer预计20:58；未触碰他人任务。
