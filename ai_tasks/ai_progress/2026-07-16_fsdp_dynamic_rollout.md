...
- server相关36 tests passed；真实latest组件one-off：StateProjector16384→8192→8192、WM8192、Value1024成功load。真实SFT1 processor+ID8 PNG构造k8 prompt：input(1,206)、query block positions192..199、IDs151665..151672、pixel_values非空。当前尚未提交GPU prep或k8 smoke；需先完成docs commit、on-experiment-start记录、W&B新ID/output和clean server worktree。
