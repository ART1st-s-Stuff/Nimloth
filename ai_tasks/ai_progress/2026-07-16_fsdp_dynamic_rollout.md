...
- commit c6ecb9c将normal 5+3 trainers改为Slurm动态选节点，只固定preflight-proven dgx48 env并排除protected SFT节点。ID20 active attempt2 job479001当前PENDING/Resources/elapsed0；当前SchedNodeList为dgx09/dgx27/dgx48但trainer ReqNodeList为空，资源变化时可重选。尚无trainer artifact，fixed20仍阻塞。
