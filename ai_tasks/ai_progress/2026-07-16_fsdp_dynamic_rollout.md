...
- 新ID20/W&B`n34u6ifk`/job478990已提交，配置保持ID12 immutable complete Epoch2、base_train seeds30002/30003、schema-v3 full-token actor old/reference replay、low-var KL0.001、FA2、vision/StateProjector freeze。提交后dgx09被新任务占满，三组当前PENDING/Resources/elapsed0；leader滚动估计11:05，不是可靠预约。尚未获得allocation或产生trainer artifact，fixed20仍阻塞。
