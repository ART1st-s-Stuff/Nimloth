...
- ID14 W&B=`cfm6lpiz`/job478603通过world8/free-port/env/multimodal gates，但共享rank7 env GPU导致`thor-CloudRendering`持续99% SM、rank7阻塞、其他FSDP ranks 0%等待；11:18取消且0 trajectory/step，终态FAILED/NON-RESUMABLE。登记E0036；后续必须8 trainer GPUs+独立第9 env GPU。launcher改为3+2+2+1 normal trainers+dgx37 env。
