...
- Corrected-resolution B job `481072`: running on dgx-32 with normal 6 GPUs (2 env + 4 policy requested), W&B ID11, output `outputs/experiments/rollout_resolution/2026-07-20/11_resprobe_step60_train120_img252_greedy`. Startup GPU probes are in progress; GPU0 is AI2-THOR capable and GPUs1-2 timed out and will be reserved for policy.
