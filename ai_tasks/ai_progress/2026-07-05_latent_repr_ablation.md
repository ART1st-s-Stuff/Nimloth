...
- Compressed vision-token LeWM-style diagnostic 本地验证：`py_compile` 覆盖 `compressor.py`、`train.py`、`config.py`；direct / compressed vision-token 1-step 与 rollout4 YAML load 通过。
