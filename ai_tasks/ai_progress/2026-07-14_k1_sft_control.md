...
- SFT2 compact cache job `475715` is healthy on intel-01. At elapsed00:35 it had 136/464 train image shards (~29%, 21GiB), with correct k1 config, epoch5 merged init, all3217/val355, BF16, 8 workers. SFT2 train `475716` remains dependency-gated; no SFT2 W&B run yet.
