...
- Final job `476585` requests 2 normal-partition GPUs on dgx-52, batch2/GA16/effective batch64, 16 CPU, 128G RAM, and 48h. It remains `PENDING (Priority)` with no training log/checkpoint. Periodic latest checkpoints support the expected resume if 10 epochs exceed 48h.
