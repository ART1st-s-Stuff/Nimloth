...
- GPU memory=~62.5–63.0GiB/81.6GiB and utilization=97–100%; no traceback/OOM/NaN/Inf. W&B train/val payloads are visible. Preliminary epoch1 k1 WM MSE is above k8 epoch1 (`0.00463` vs `0.00227`), but later epochs are needed. End-to-end throughput gives ~40–42h remaining versus ~41h allocation remaining, so walltime completion is possible but tight; periodic latest supports recovery.
