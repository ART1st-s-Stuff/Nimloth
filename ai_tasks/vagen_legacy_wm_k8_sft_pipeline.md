...
日期：2026-07-09
状态：已hold IDLE dgx-38六卡；首次srun因旧failed marker竞态退出，hold保留并修复后同allocation重试
...
- Full-scale独占根：`outputs/experiments/vagen_legacy_wm_k8_full/2026-07-10/full_2e66e97`。按人类更新，hold471146先占IDLE dgx-38六卡并启动step471146.0，随后取消normal471140。全部6卡AI2-THOR smoke通过，但父进程在child清理前读到旧dgx-11 attempt的`failed` marker而exit4，无server/shard；hold仍运行。已修复parent pre-spawn清attempt marker竞态并新增E0013，待同allocation retry。
