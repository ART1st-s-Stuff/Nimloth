...
- W&B project: `vagen`.
- W&B run name: `187_smoke_rollout_browser_k4_dp8_tp8_source20_base_seed2_t20_s100_preempt_retry13`.
- W&B run ID: `nimloth-id187-smoke-rollout-browser-k4-source20-seed2-preempt-r13`; `resume=never`.
- Output: `/project/peilab/atst/nimloth/outputs/experiments/training/rl/2026-08-21/187_smoke_rollout_browser_k4_dp8_tp8_source20_base_seed2_t20_s100_preempt_retry13`.
