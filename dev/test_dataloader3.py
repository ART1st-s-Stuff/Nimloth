"""Test DataLoader iteration speed - minimal version."""
import sys
import time
import torch
...
print("Starting minimal DataLoader test...")
...
with initialize_config_dir(config_dir=str(config_dir), version_base=None):
    ...
    print(f"wm.latent_dim: {wm_cfg.latent_dim}")
    ...
    print(f"Item 0 loaded in {elapsed:.2f}s")
