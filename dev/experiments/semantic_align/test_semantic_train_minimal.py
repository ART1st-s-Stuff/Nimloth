#!/usr/bin/env python3
"""Minimal Phase 3 training - no wandb, no rich progress, direct stdout."""
...
with initialize_config_dir(version_base=None, config_dir=str(cfg_path)):
    ...
    for epoch in range(total_epochs):
        ...
        for batch_idx, batch in enumerate(loader):
            ...
            # Early stop for testing (first 1000 batches)
            if batch_idx >= 1000:
                print(f'Early stop at batch {batch_idx}', file=sys.stderr, flush=True)
                break
