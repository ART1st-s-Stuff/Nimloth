...
factorized often drifted to generic doors or rooms. Neither followed all turn
views faithfully. The 2048 bottleneck is therefore the stronger dynamics and
efficiency default for complete SFT2, with an explicit decoder-visible detail
limitation. This is not a matched-parameter result or an overall visual win.
