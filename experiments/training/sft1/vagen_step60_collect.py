...
from nimloth.environment.navigation.source_client import (
    LegacyVAGENBatchClient as _BatchTransport,
)
...
class LegacyVAGENBatchClient(_BatchTransport):
    """Collection adds reconstruction identity to the shared batch transport."""
