...
srun --jobid="${HOLD_JOB}" --overlap --nodes=1 --ntasks=1 \
  ...
  env "${COMMON_ENV[@]}" RAY_ADDRESS="${RAY_ADDRESS}" \
    ...
    ID185_HEAD_IP="${HEAD_IP}" ID185_EXPECTED_NNODES=4 \
    ID185_EXPECTED_GPUS_PER_NODE=2 ID185_EXPECTED_GPU_COUNTS=2,2,2,2 \
    ID185_HEAD_GPU_COUNT=2 ID185_CLUSTER_NODES="${ID185_CLUSTER_NODES}" \
