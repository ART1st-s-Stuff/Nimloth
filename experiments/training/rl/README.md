...
`dynamic_fsdp_k8_fragmented_8plus1.slurm` 当前只接受 `RUN_MODE=smoke|baseline`，明确拒绝 pilot。
...
| `dynamic_fsdp_k8_fragmented_8plus1.slurm` | 2×4-GPU normal fragments（world8）+ 1-GPU env fragment；含真实 artifact gate |
