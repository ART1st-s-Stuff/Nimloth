...
`dynamic_fsdp_k8_fragmented_4plus3plus1_env1.slurm` 当前只接受 `RUN_MODE=smoke|baseline`，明确拒绝 pilot。
...
| `dynamic_fsdp_k8_fragmented_4plus3plus1_env1.slurm` | 4+3+1 normal trainer fragments（world8）+ 1-GPU env fragment；含真实 artifact gate |
