#!/usr/bin/env python3
"""Convert a VAGEN HF export into FSDP shards for the current Ray world size.

This is a checkpoint conversion entrypoint, not rollout or training. It
initializes VAGEN/verl actor/critic/ref workers from the HuggingFace export,
then calls the native FSDP checkpoint saver for the active world size.
"""
