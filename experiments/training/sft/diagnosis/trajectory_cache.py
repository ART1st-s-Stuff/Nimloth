...
def encode_trajectory_record(
    ...
    *,
    ...
    from experiments.training.sft.diagnosis.trajectory_once import encode_full_trajectory
...
class CachedTrajectoryDataset(Dataset):
    def __init__(self, cache_dir: Path, samples: list[TransitionSample]) -> None:
        from experiments.training.sft.diagnosis.trajectory_batching import build_record_trajectory_batches
