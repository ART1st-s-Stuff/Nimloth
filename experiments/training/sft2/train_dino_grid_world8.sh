...
TRAIN_JSONL=${TRAIN_JSONL:-/project/peilab/atst/nimloth/outputs/experiments/vagen_legacy_wm_k16_grid/2026-07-25/sft2/49_terminalcot_validonly_dinogrid_k16_h4_untiedhead_fp32aux_ep2_b1_ga8_ws8_px100352/data/train_terminal_cot.jsonl}
VAL_JSONL=${VAL_JSONL:-/project/peilab/atst/nimloth/outputs/experiments/vagen_legacy_wm_k16_grid/2026-07-25/sft2/49_terminalcot_validonly_dinogrid_k16_h4_untiedhead_fp32aux_ep2_b1_ga8_ws8_px100352/data/val_terminal_cot.jsonl}
