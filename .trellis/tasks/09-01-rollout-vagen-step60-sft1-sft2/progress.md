...
- R7 is terminal/non-reusable. Every future `srun` in a streamed remote script must close stdin explicitly with `--input=none` (or equivalent reviewed redirection).
