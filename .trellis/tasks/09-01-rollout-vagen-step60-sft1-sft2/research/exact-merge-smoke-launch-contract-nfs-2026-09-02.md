...
This contract replaces the terminal failed pre-W-013 contract with post-W-013 Nimloth commit `32bcc04511364801c99884e836a9d3b27db7d2e6` and a fresh unused run identity. It authorizes nothing until its exact committed artifact and command scope receive a separate experiment-launch approval. It covers checkpoint actor merge/load plus source-index-0 smoke only; it excludes the 100-row gate, remaining batch1 shards, conversion, training and batches2–10.
