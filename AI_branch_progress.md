...
- Rollout/converter、SFT1/SFT2全部preflight gate通过；partial resume有界数值复现，不宣称bit-exact。人类已确认启动full-scale。独占根 `outputs/experiments/vagen_legacy_wm_k8_full/2026-07-10/full_2e66e97`；external env job471020（normal/dgx-16/4GPU）处于Priority等待，rollout array471026（0-3%2/2GPU）以`after:471020`依赖提交，当前Dependency等待，尚未消耗本实验GPU或产生rollout shard。
