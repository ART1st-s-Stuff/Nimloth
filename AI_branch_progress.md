...
- 第三步实现frozen deterministic scaffold + residual CFM：6ch输入(noisy residual+spatial scaffold)、`t=U²`低t偏置、velocity MSE+0.5 image L1，提交`e17c7c7`、server7 tests passed。tiny64 job474928已提交normal等待资源；W&B预定ID6。
