...
- 新retry ID10：`2026-07-17/10_smoke_fsdpdynamic_k8full8192_sft2j477349_frag2x1_iter1_b2_retry1`，W&B`bvdnc6h4`已实际创建step0并记录。将从job477349届时最新完整`train/latest`重新稳定snapshot/merge，不使用ID9 init；代码`fd1c435`server26 tests+Slurm syntax通过；prep→fragmented smoke，无resume。详见`ai_tasks/ai_progress/2026-07-16_fsdp_dynamic_rollout.md`。
