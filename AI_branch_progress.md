...
- 正式CFM输出`.../cfm/2_cfm128_sft2e2_k8_all3217_ep10_b32_lr1e4`，train59,389/val6,054，10 epochs/18,560 sampled steps/b32/lr1e-4，W&B project=`nimloth-recon`、run ID序号2。首个formal job474764在训练/W&B前发现逐pixel Python conversion导致CPU preload慢，03:23主动取消；NumPy contiguous RGB等价优化提交`06f830a`、server5 tests passed，retry474775在normal/dgx-18运行。
