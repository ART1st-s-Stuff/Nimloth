...
- smoke job475045 `COMPLETED00:01:07`：cache train77/val16且alignment通过，paired step10/checkpoint/contact/W&B`90im9e9r`均finite。resume gate475048 `COMPLETED00:00:32`，cache hit、step10→12并复用同W&B ID。短smoke ratio≈1不作质量解释。原formal normal8 jobs475049/475050因预计2026-07-16才开始而在执行前取消；有效replacement为normal2 cache475052（strict train59,389/val6,054、expected3.75GiB、4–6h）和afterok paired train475053（b16/18,560≈5ep，W&B ID10），预计cache 2026-07-15 06:07启动。已检查所有normal/preempt节点均allocated/mixed，无可立即调度2GPU资源。
