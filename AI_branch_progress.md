...
- 2026-07-12 dgx-44 task0已完成并严格通过：1080 records/21,752 PNG，seeds1-360九shards row/seed/transcript/image完整。deferred monitor误用`sacct -X`而读取外层allocation RUNNING，造成约13min idle；已停止并登记E0018，确认无GPU重叠/数据损坏后手动启动fresh task1-only orchestration（hold472930，绝不task2）。dgx-48 task2已完成721-880四shards并运行881-920。检查时combined durable2220/3900、41,834 PNG。
