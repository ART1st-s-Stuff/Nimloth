...
- Pilot ID11=`2026-07-17/11_pilot_fsdpdynamic_k8full8192_sft2step3059_frag2x1_iter20_b8_heldout20_visfreeze`、W&B`u67p32ee`，复用成功ID10的immutable **init**（非其RL checkpoint）。job477562 dgx-21+52 trainers/dgx-37 env COMPLETED16:32、ALL_OK，按批准guardrail在iter5/global_step5因40/40 train trajectories（800 transitions）0 success early-stop，未运行10/15/20。五次update全部finite；train总reward按轮-13.3/-5.3/-5.7/-4.4/-7.4但任务不同，仅诊断。固定heldout base baseline0/20→iter5 0/20，avg reward0→0、steps20→20；IDs/instructions完全相同，greedy 400 actions均rotateright，未观察到行为或成功率提高。Unity初始frame并非全bitwise（5/20 exact，其余通常max channel差1–2，一例9），已披露但task/seed/action/outcome一致。final：LLM B252/252 changed；该次Vision freeze B0/96 changed；StateProjector BF16 exact；WM97/97、Value4/4 changed finite；optimizer两rank全finite/无zero shape；iter5/best/final约31GiB保留。结论仅为该pilot无初步提高，20 heldout不足以泛化质量。详见`ai_tasks/ai_progress/2026-07-16_fsdp_dynamic_rollout.md`。
