...
- 新retry ID10：`2026-07-17/10_smoke_fsdpdynamic_k8full8192_sft2j477349_frag2x1_iter1_b2_retry1`，W&B`bvdnc6h4`已实际创建step0并记录。prep477537完成：job477349 stable latest step3059/epoch2 partial/micro11232、merge826 tensors、init12GiB，不使用ID9 init。首个allocation477542虽ReqNodeList为候选18/21/32/34，却实际分配受保护dgx-14+21；9秒内立即取消，未启动trainer/W&B/trajectory/checkpoint。登记E0031，改用group0硬exclude job477349的14/26/51/54，env显式dgx-37；ID10仍可retry，无resume。详见`ai_tasks/ai_progress/2026-07-16_fsdp_dynamic_rollout.md`。
