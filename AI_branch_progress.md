...
- ID14 W&B=`cfm6lpiz`/job478603验证free-port、world8、env health和multimodal image gate均通过，但错误地让AI2-THOR共享rank7 H100；`thor-CloudRendering`持续99% SM，rank7阻塞GPU runtime，其他7个FSDP ranks以0% SM等待collective。确认后11:18取消，0 trajectory/optimizer step，终态FAILED/NON-RESUMABLE且无semantic结论。登记E0036；下一smoke严格要求8个dedicated trainer GPUs+独立第9个env GPU，launcher改为normal 3+2+2+1 trainers和dgx37 env。
