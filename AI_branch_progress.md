...
- 人类改为凑`2+2+2+2`。Phase1/2现严格normal 4节点×每节点2 H800/16CPU/64GiB，总资源及actor DP8、rollout TP8/DP1不变；四个10.23 IP/fabric、1 head+3 worker raylets、逐节点dataset import、cleanup和monitor均fail closed。独立首轮review抓出VAGEN仍为`[4,4]` STRICT_PACK的P0，故未误提交；现config/main gate/resource pool已改为`4×2/[2,2,2,2]`。VAGEN=`60b166c`、parent=`e4f95153`，服务器VAGEN`26 passed,32 subtests`+parent`11 passed`，复审`APPROVE`无P0/P1。phase2仍未提交。
