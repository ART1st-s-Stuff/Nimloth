...
- 人类选择smoke通过后自动formal。real-data smoke479978 `COMPLETED00:02:27` exit0/dgx-14，W&B`ndcz52xp`：2GPU/world1 pair、strict train4/val2、35 optimizer steps+val，真实nonpacked per-prefix/next-prefix path、LoRA/EMA/aux DDP均通过，无OOM/nonfinite/error。val WM MSE.00463178优于identity.00469884，gain +.00006706；pred cos.996288 vs identity.996225。epoch1 step35 complete；WM config exact T4/token8/residual，70 floating tensors全finite，zero-init delta final weight已学到norm.718647。afterok formal479979已释放并PENDING Resources：输出SFT2 ID29，strict train3217/disjoint val355、production prebuilt cache、world4 pair/dgx27x6+dgx54x2/GA8/5ep；hetero group0 limit48h/group1 scheduler cap8h，20min latest可精确resume，首allocation最多约8h后需续提。
