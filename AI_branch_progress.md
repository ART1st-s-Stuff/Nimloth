...
- 正式CFM输出`.../cfm/2_cfm128_sft2e2_k8_all3217_ep10_b32_lr1e4`，job474764已在normal/dgx-18运行；train59,389/val6,054，10 epochs/18,560 sampled steps/b32/lr1e-4。W&B project=`nimloth-recon`、run ID序号2；当前处于全量image/state preload阶段。
