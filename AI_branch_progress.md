...
- 当前恢复：env job `468785` 在 `dgx-12`/`preempt` 4GPU 已 ready，URLs `http://dgx-12:20730-20733`；rollout array `468792_[0-3%2]` 已在 `ready_job_id=468785` 后提交。`468792_0` on `dgx-13` 和 `468792_1` on `dgx-28` 正在运行，已正确跳过完成的 `shard_001_180` / `shard_361_540`，当前目标为 `shard_181_360` 和 `shard_541_720`；`468792_2/3` 因 array throttle pending。暂未写出新 JSONL。
