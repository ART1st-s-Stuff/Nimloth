...
- 人类决定从corrected ID3完整重训SFT2。现有train八动作计数为`[31272,1598,8590,13701,2699,729,271,409]`；该不平衡是环境state occupancy与behavior共同形成的目标分布，必须原样训练。AI错误建议类别平衡action CE，经人类纠正后撤回并登记`E0112`；禁止class weight或动作过采样，仅允许分动作监测。
