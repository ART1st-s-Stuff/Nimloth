...
- 新增bounded env semantic preflight。ID17 job478728在dgx29 COMPLETED0:0/45s：health、create9.02s、prompt0.002s、reset0.67s、真实obs_str/one-image/Human Instruction schema及close全部通过，task为StoveBurner导航。下一smoke用4@dgx09+2@dgx13+2@dgx37 dedicated trainers，dgx29 dedicated env；不再仅凭`/health`选节点。
