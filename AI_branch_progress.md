...
- fair8-token Projected CFM storage-safe链完成：smoke479937 42s/W&B`vmkfshpz`；formal479938 `COMPLETED01:00:04`/W&B`yi808j9e`，55,680/30ep，full correct.0397936/shuffled.0398938/ratio1.002517，仍未过gate且不优于single-token ratio1.002801，故旧single256 bottleneck不是主因。eval479939 `COMPLETED01:51`/W&B`7skxv7oc`，40runs/200frames：L1 Qwen.275183/Query.326296/actual fair Projected.367705/predicted.344066；actual较sharp/varied但hallucination更重，predicted仍dark/beige collapse；匹配8-token interface未恢复Project State视觉敏感性，主要限制指向Projected representation/training objective。
