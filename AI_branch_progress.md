...
- corrected ID178把ownership分开：`--model`固定ID176 complete Qwen shards，`--critic-checkpoint`固定original ID74 root及`training_state.pt` SHA`cce9c81d...`和planning sidecars。其余合同逐值不变；尚未提交/启动。
