...
- 4×2 Phase1 Job`520935`于20:18提交后始终pending、elapsed0、无节点/output/W&B；人类随后临时允许dgx-23/37，故取消该job。ID183专用Phase1/2和双层runtime gate现只排除13/32/51，parent=`f37abda7`、服务器launcher`11 passed`。fresh runtime preflight确认retry output/W&B仍absent；新Phase1 Job`521033`于21:51提交同一4×2/总资源/5h合同，当前`PENDING(Priority)`，预计23:02，可调度候选包含23/27/30/37。phase2仍未提交。
