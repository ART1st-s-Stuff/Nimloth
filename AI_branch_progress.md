...
- fresh worktree重验retry2 output/W&B absent和retry1证据保留；diagnostic retry Job`521267`于01:48提交同一normal exact4×2/64CPU/256GiB/5h合同，仅排除13/32/51。当前`PENDING(Priority)`、elapsed0；test-only预测候选09/18/23/29。phase2未提交。
