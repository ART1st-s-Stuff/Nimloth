...
- replacement cache job473873已在CPU intel-01健康启动（8CPU/128G/12h）；formal 8×H800 train job473874已按`afterok:473873`提交。实验代码commit=`453667c`，输出与W&B run name均为`1_k8inject_all3217_qadapter_vfull_wmtrain_ep10_b2_ga4_px100352_img12_bestwm`。
