...
- 新T4 residual SFT2 formal479979于12:24:56 HKT获得dgx-27+dgx-54并健康RUNNING；13:42约step552/8275、epoch1 33%，W&B`nvy3monl`。last100(step456–555)均值：WM MSE.007400 vs identity.013084，gain+.005169且89% steps为正；pred cos.94121 vs identity.90193，说明正式数据上已明显超过identity（尚无epoch val）。约8.5s/step，epoch1 ETA~16:20，五轮连续约19.5h remaining；dgx-54 component8h cap于20:24前终止，latest atomic已在13:27写入且每20min续写，届时必须续提。无traceback/OOM/nonfinite；stdout主要NCCL init属正常。
