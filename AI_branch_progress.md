...
- corrected recursive-T1 diverse40 eval479918 `COMPLETED00:01:56` exit0/dgx-27，W&B`x8fqdses`已重传；metadata确认one-slot/T1。结果仍是beige/gray collapse：L1 predicted.320138，State MSE.0034163/cos.70357，horizon cos .711/.689/.670/.704/.744；与无效T4 run的.320217/.003393/.70529几乎相同。因此T4协议是必须修复的结构bug，但不是该checkpoint视觉失败的主要实证原因；训练一致T1确认h1即有较大State angular/off-manifold gap。结论仍受Projected CFM correct/shuffled1.0028未过gate限制；公平比较是同CFM的actual Projected vs predicted，Query vs predicted还混入projector与不同decoder差异。
