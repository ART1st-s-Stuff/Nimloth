...
- 人类选择smoke通过后自动formal。real-data smoke479978已于dgx-14 RUNNING，W&B`ndcz52xp`，2GPU/world1 pair、strict train4/val2、SFT1 epoch5 init、new aux heads/WM，当前成功载入Qwen/LoRA/vision EMA/pair topology，无error，等待首个forward/backward。afterok formal479979已提交：输出SFT2 ID29，W&B同名，strict train3217/disjoint val355、production prebuilt cache、world4 pair/dgx27x6+dgx54x2/GA8/5ep；hetero group0 limit48h/group1 scheduler cap8h，20min latest可精确resume，预计首allocation最多跑8h后需续提。
