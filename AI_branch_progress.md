...
- 已启动 compressed predictor rollout4 full job `466250`（commit `7de369e`，`MAX_RECORDS=-1`, `SAVE_INTERVAL=5000`, `EVAL_MAX_RECORDS=360`），输出 `/project/peilab/atst/nimloth/outputs/experiments/representation_ablation/2026-07-06/compressed_vision_rollout4_full_s5000_7de369e_466250`。已确认在 dgx-29 上运行，使用 `/project/peilab/atst/nimloth/.venv-vagen-main/bin/python`，GPU memory 约 9.7GB，训练进程健康。RCDM direct-concat visualization 尚未接入。
