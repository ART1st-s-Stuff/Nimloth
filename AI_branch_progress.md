...
- smoke job475045 `COMPLETED00:01:07`：cache train77/val16且alignment通过，paired step10/checkpoint/contact/W&B`90im9e9r`均finite。resume gate475048 `COMPLETED00:00:32`，cache hit、step10→12并复用同W&B ID。短smoke ratio≈1不作质量解释。原formal normal8 jobs475049/475050因预计2026-07-16才开始而执行前取消。normal2 cache475052已在dgx-29运行00:05:10并写2×512-row partial shards，却被agent为尚未获得的dgx-22 4GPU投机性replacement错误取消；475078始终未运行。人类指出后已登记E0029。当前有效normal2 cache475097在dgx-09 `COMPLETED02:46:36` exit0：train59,389/116 shards/1,961,361,676B，val6,054/12/199,940,660B，manifest `[8,2048]` FP16完整。afterok paired train475098已在dgx-09启动，W&B`cgkd3gi0`；step1000 preliminary projected correct0.131841/wrong0.131841/ratio1.000004，query correct0.121676/wrong0.122820/ratio1.00941，query output delta0.03067 vs projected0.01297。仅早期趋势，不作最终结论；当前至少step1600/18,560且无traceback/OOM。
