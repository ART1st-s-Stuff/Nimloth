...
- 人类批准继续后准备ID177 optimizer-free calibration：严格固定ID176 completion marker SHA`37a40f08...`、Qwen shard SHA`63c933b6.../fcfec949...`及ID74 planning sidecar SHA；其余仍为24条train3×8、20 turns、TP8、K4/100/c1、beta0、seed172001。新增独立batch/launcher/runner和静态测试，禁止optimizer/checkpoint/W&B/canary并在beta proposal后停下。尚未启动。
