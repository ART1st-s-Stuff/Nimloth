...
- ID175 launcher固定ID74 model index SHA`32acf7bf...`、train/val SHA`d43ada06.../4c092fb4...`及cache manifest SHA`3e501a0c.../acd10994...`；配置为8×H800、271×8 train/40×8 val、seed42002、delta AdamW LR`1e-4`/WD0、最多500 epochs/patience50、heldout NLL improvement≥0.05、BF16 median spread>0.001。服务器定向`35 passed`且五层clean；尚未启动GPU。
