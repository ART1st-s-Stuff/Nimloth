...
- 新phase1 Job`520684`于16:38提交normal 2×4；当前只有允许节点dgx-52拥有≥4空GPU、尚缺第二节点，因此仍`PENDING(Priority)`，未占GPU、创建output/W&B或开始训练。phase2仍只在phase1 step5、validator、W&B完成后提交。
