...
- 旧 step79 VAGEN checkpoint provenance：直接 artifact 未记录训练时 branch/commit/dirty status；子 agent 基于远程 Git reflog 重建，最可能为 Nimloth repo `main` commit `2f683f5de25c5eaf0b804f1fbadc507697c336a6`，`external/VAGEN` branch `main` commit `629c270cf069680c70282f615e7f1b83a45684ab`，VAGEN nested `verl` commit `6360bfe706a00b4ece9105285776b5727ee449b7`。confidence=medium，无法排除当时未提交改动；W&B retro metadata commit `3342f0cc...` 属事后上传脚本，不是训练 provenance。
