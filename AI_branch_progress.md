...
- 4×2 Phase1 Job`520935`于20:18提交：normal、4节点、每节点2 H800/16CPU/64GiB、总8 H800/64CPU/256GiB、5h，排除13/23/32/37/51。test-only曾预测18/21/29/30；当前`PENDING(Priority)`、elapsed0、无节点/output/W&B。phase2仍未提交。
