...
- Pilot ID11=`2026-07-17/11_pilot_fsdpdynamic_k8full8192_sft2step3059_frag2x1_iter20_b8_heldout20_visfreeze`、W&B`u67p32ee`已实际创建step0。复用成功ID10的immutable **init**（非其RL checkpoint）：20轮×8条base_train×20步，batch2；固定20条heldout base baseline及iter5/10/15/20 greedy评估；iter5前train0 success则early-stop；显式Vision freeze，硬exclude live SFT nodes，world-size2 checkpoint/resume。待提交。详见`ai_tasks/ai_progress/2026-07-16_fsdp_dynamic_rollout.md`。
