...
- 原CSV已归档为`train_step_log_preempted_473978.csv`，active CSV原子截到checkpoint step2137。resume job474104已无节点绑定提交preempt 8GPU，当前`PENDING(Priority)`；提交时所有显示8卡空闲的preempt节点均DOWN/NOT_RESPONDING。
