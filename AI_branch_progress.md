...
- 2026-07-12 workflow-first collection job472590（dgx-44,6GPU,8h）运行中，`d2046d6`/VAGEN`e7cc2d0`，顺序3,0,1,2，全部使用源train-time eval kwargs。已完成val1081-1160两个shards：240 records/4,257 PNG，0 bad JSON/empty/missing image，success85/240=35.42%，5 records有unsupported/missing action供workflow strict-validation处理；第三个val shard1161-1200正在生成，无traceback/timeout。
