...
- ID185 retry2 Job`523996`于2026-08-19 20:45:38 HKT在`dgx-[14,21,27,35]`提前启动。动态认证首个candidate head14成功；正式runner FloorPlan1 render用时`3.657s`，五类environment prewarm分别`5.319/3.125/3.089/3.045/3.753s`并全部通过。exact4×2 Ray/import/source step20/hash/300-row manifest/checkpoint/SIGReg门禁均健康，TaskRunner和DP8 model loading已开始；截至20:52 elapsed约7分钟，无fatal/traceback/OOM，尚未产生正式validation指标。
