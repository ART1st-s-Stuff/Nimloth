...
_YAML_TO_ARG: dict[tuple[str, str], str] = {
    ...
    ("train", "wm_history_size"): "wm_history_size",
    ("train", "wm_state_token_count"): "wm_state_token_count",
    ("train", "wm_residual_prediction"): "wm_residual_prediction",
    ("train", "wm_predictor_hidden_dim"): "wm_predictor_hidden_dim",
    ("train", "wm_predictor_mlp_dim"): "wm_predictor_mlp_dim",
    ("train", "wm_predictor_heads"): "wm_predictor_heads",
    ("train", "wm_predictor_dim_head"): "wm_predictor_dim_head",
    ("train", "wm_predictor_depth"): "wm_predictor_depth",
