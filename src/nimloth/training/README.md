...
|----------------------|---------|
| `nimloth.backbone/` | Qwen2.5-VL tuning、vision EMA、冻结且显式选型的 DINO teacher |
...
| `training/sft2/` | trainer, step, checkpoint, evaluate, loss, cli；可把 projected current query state 直接对齐当前 RGB 的 DINO CLS 特征 |
