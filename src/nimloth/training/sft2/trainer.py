            ...
            with log_path.open("a", newline="") as f:
                csv.writer(f).writerow(
                    [
                        ...
                        avg.get("total_loss", ""),
                        avg.get("wm_mse", ""),
                        avg.get("wm_identity_mse", ""),
                        avg.get("wm_gain_over_identity", ""),
                        avg.get("wm_pred_cos", ""),
                        avg.get("wm_identity_cos", ""),
                        avg.get("sigreg_loss", ""),
                        avg.get("value_total", ""),
                        avg.get("value_reg", ""),
                        avg.get("value_rank", ""),
            ...
            with log_path.open("a", newline="") as f:
                csv.writer(f).writerow(
                    [
                        ...
                        val_metrics.get("wm_identity_mse", ""),
                        val_metrics.get("wm_gain_over_identity", ""),
                        val_metrics.get("wm_pred_cos", ""),
                        val_metrics.get("wm_identity_cos", ""),
