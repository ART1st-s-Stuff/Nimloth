...
_YAML_TO_ARG: dict[tuple[str, str], str] = {
    ...
    ("init", "grid_warmstart"): "grid_warmstart",
    ...
    ("train", "dino_decoder_lr"): "dino_decoder_lr",
    ...
    ("grid", "size"): "grid_size",
    ("grid", "ema_decay"): "grid_ema_decay",
    ("grid", "encoder_hidden_dim"): "grid_encoder_hidden_dim",
    ("grid", "decoder_hidden_dim"): "grid_decoder_hidden_dim",
